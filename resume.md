...
### 組織マネジメント
- 開発メンバー15名、3チームのマネジメント
- 組織再編における体制刷新の策定とリード、保守運用体制の再設計と継続見直し
- 各チームのプロダクトロードマップ達成に向けた推進
- 各メンバー異動に向けた交通整理と体制づくり

### 採用
- 社員採用人員計画の策定、JDの構築
- 採用スカウト媒体の精査、月次のエージェントとの連携
- 有志での採用広報チームの構築と定期モニタリングの推進

### デザインシステム開発
- 大規模システムリプレイスに向けた、デザインシステムの構築チームの立ち上げ
- デザイナー/エンジニア間の連携方針の設計、デザインシステム構築の開発リード

### 運用改善
- 運用問い合わせの負担改善を進めるチームの立ち上げ
- 管理画面拡張でのCS負担削減、AI駆動での問い合わせ対応自動化に向けたミッション、タスク整理と推進

### toB 向けプロダクト開発
- 事業計画におけるスケジュール必達に向けた、炎上対応に伴うスコープマネジメント、体制マネジメント(異動・委託による人員補填、メンバーの役割調整等)
- 事業ロードマップの変更に伴う、プロダクトロードマップの刷新とステークホルダーへのネゴシエーション
- 来季に向けた体制構築と差し込み案件のバックログ整備

## 2025.3~2025.8 EM 兼 事業企画
### 新規事業立案
